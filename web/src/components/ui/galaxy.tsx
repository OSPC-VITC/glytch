...
export default function Galaxy({ transparent = true, ...rest }: GalaxyProps) {
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      (program.uniforms as any).uStarSpeed.value = (t * 0.001 * 0.5) / 10.0;
    ...
    return () => {
      ...
      ctn.removeChild(gl.canvas as unknown as Node);
      (gl as any).getExtension("WEBGL_lose_context")?.loseContext();
    };
  }, [transparent]);

  return <div ref={ctnDom} className="w-full h-full" {...(rest as any)} />;
}
